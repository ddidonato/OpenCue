...
DEFAULT_CHUNK_MAYA = config.get('DEFAULT_CHUNK_MAYA', DEFAULT_MIN_CORES)
DEFAULT_CHUNK_NUKE = config.get('DEFAULT_CHUNK_NUKE', DEFAULT_MIN_CORES)
DEFAULT_CHUNK_BLENDER = config.get('DEFAULT_CHUNK_BLENDER', DEFAULT_MIN_CORES)
